...
import 'package:gnac_flutter_portfolio/view/intro/components/subtitle_text.dart';
...
class CombineSubtitleText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        const Responsive(
          desktop: AnimatedSubtitleText(start: 45, end: 30, text: 'Flutter '),
          largeMobile:
              AnimatedSubtitleText(start: 30, end: 25, text: 'Flutter '),
          mobile: AnimatedSubtitleText(start: 25, end: 20, text: 'Flutter '),
          tablet: AnimatedSubtitleText(start: 35, end: 30, text: 'Flutter '),
        ),
        (kIsWeb && Responsive.isLargeMobile(context)
            ? const Responsive(
                desktop: AnimatedSubtitleText(
                    start: 35, end: 30, text: 'Developer ', gradient: true),
